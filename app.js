...
var taskInput=document.getElementsByClassName("new-task__input-for-name")[0]; //Add a new task.
var addButton=document.getElementsByClassName("new-task__btn-add")[0]; //first button
var incompleteTaskHolder=document.getElementsByClassName("section__list_incomplete-tasks")[0]; //ul of #incomplete-tasks
var completedTasksHolder=document.getElementsByClassName("section__list_complete-tasks")[0];//complete-tasks
